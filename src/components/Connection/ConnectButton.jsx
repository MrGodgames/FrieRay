    ...
    return (
        <div className="connect-wrapper">
            <div className="connect-area">
                {isStrict ? (
                    <div className={`strict-rings ${connecting ? 'spinning' : ''} ${connected ? 'active' : ''}`} aria-hidden="true">
                        <span className="strict-ring strict-ring-outer" />
                        <span className="strict-ring strict-ring-mid" />
                        <span className="strict-ring strict-ring-inner" />
                        <span className="strict-crosshair strict-crosshair-h" />
                        <span className="strict-crosshair strict-crosshair-v" />
                    </div>
                ) : (
                ...
                >
                    <div className="connect-core">
                        {connecting ? (
                            ...
                            <span className="connect-rune">{isStrict ? (connected ? 'ON' : 'GO') : (connected ? '⟡' : '✦')}</span>
                        )}
                    </div>
                </button>
            </div>
            ...
            <span className="connect-label">
                {isStrict
                    ? (connecting ? 'УСТАНОВКА СОЕДИНЕНИЯ' : connected ? 'ЗАЩИЩЕННЫЙ КАНАЛ АКТИВЕН' : 'ЗАПУСТИТЬ ПОДКЛЮЧЕНИЕ')
